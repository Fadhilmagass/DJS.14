...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const errEmbed = new EmbedBuilder()
            .setDescription("Something wrong, please try again later.")
            .setColor(0xc72c3b)
        ...
        if (member.roles.highest.position >= interaction.member.roles.highest.position)
            return interaction.reply({ embeds: [errEmbed], ephemeral: true }); // if statement ini optional (lebih baik dipake)
